...
<div className="tronText" style={{position:'absolute', zIndex:'3', right:'0', top:'10vh' }}>
            <div style={{fontWeight:'bold', padding:'0 0 0 0', fontSize:'2rem', }}>Click To Play</div>
    <ImPlay className="" style={{margin:'0 auto', width:'50%', fontSize:'60px', filter:'dropShadow(0px 0px 14px #E3272D)'}} />
            </div>
