...
.frontbg iframe {animation: fadeout 15s forwards; }
...
<div className="contact" style={{position:'absolute', bottom:'80px', zIndex:'1', left:'10%', display:'flex', justifyContent:'center', border:'0px solid red', width:''}}>
